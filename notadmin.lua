if IY_LOADED and not _G.IY_DEBUG == true then
	-- error("NotAdmin is already running!",0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'NotAdmin is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "NotAdmin v" .. currentVersion
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		if func then
			func("https://discord.gg/gcYvTCADkk")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/gcYvTCADkk)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- NotAdmin Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify('Outdated','https://github.com/TarKek/RobloxHacks')
		end
